    ...
    series: [
      {
        ...
        // 修改柱子宽度
        barWidth:'35%',
        data: [200, 300, 300, 900, 1500, 1030, 600],
        // 修改柱子圆角
        itemStyle:{
          barBorderRadius: 5
        }
...
(function(){
  ...
  $(".line h2").on('click','a',function(){
    ...
    optin.series[0].data= obj.data[0];
    optin.series[1].data= obj.data[1];
    // 需要重新渲染数据
    myChart.setOption(optin);
  })
})();
